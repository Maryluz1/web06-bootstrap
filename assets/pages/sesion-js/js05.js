 ...
 */
 ...
 //-----------Precedencia de operadorres-----------
 //https://developer.mozilla.org/es/docs/Web/JavaScript/Reference/Operators/Operator_Precedence

 const operaciones = 5 * 2 + 3 ** 2 - 4; //15
 console.log(operaciones);
 console.log(  4 % 3 + 2 * 3 / 2 - 1 );//3-------se resuelve primero el residuo, multiplicacion, division

 //----------peradores de asignación-------------

 /* 
 Asigna un valor a su operador izquierdo basandose 
 en el valor de su operador derecho:

 asignación =

 operadores abreviados ( o compuestos ):
op1 += op2 -> op1 = op1 + op2
op1 -= op2 -> op1 = op1 - op2
op1 *= op2 -> op1 = op1 * op2
...
console.log( 2 ** 3 ** 2 ); // 512 -------- se resulve primero de derecha a izquierda
...
//Conversion numerica
let pago = + dinero; // -3 Nose le cambia el signo
let intereses = "5.23"; // 5.23 numerico
console.log( typeof (intereses) ); //number
intereses = 3;
console.log(intereses += + + "3" ); //11--------en " + "3" " el incremento hace la conversion de "3" a number

// Operador logico not
let isActive = !true; // false -------Este operador devuelve lo contrario, si es true devolverá false
...
/* 
   ...
   Operador de post-incremento y post-decremento // se ejecutará  hast ala proxima vez que se vuelva a utilizar 
